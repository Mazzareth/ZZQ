...
import { ZZQContextMenu } from "@/components/ui/zzq-context-menu";
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {/* Metrics Cards */}
       <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 mb-8">
         <ZZQContextMenu contextLabel="Total Clients">
         ...
         <ZZQContextMenu contextLabel="Total Earned">
           <Card className="bg-white shadow-sm">
             <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
         ...
         <ZZQContextMenu contextLabel="Total Pending Earnings">
           <Card className="bg-white shadow-sm">
             <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
      ...
      {/* Charts and Activity Section */}
       <div className="grid gap-6 md:grid-cols-2">
         {/* Sales Chart */}
         <ZZQContextMenu contextLabel="Sales Growth Chart">
           <Card className="bg-white shadow-sm">
             <CardHeader>
         ...
         {/* Recent Activity */}
         <ZZQContextMenu contextLabel="Recent Activity">
           <Card className="bg-white shadow-sm">
             <CardHeader>
